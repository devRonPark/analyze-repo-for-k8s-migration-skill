...
| DET-008 — invented line ranges | TODO | The same rerun cited real paths with six out-of-range line spans, left two `search(scope=` markers, and omitted `## 6. 설정과 상태 상세`. | Needs agent-instruction changes and an E2E rerun. |
