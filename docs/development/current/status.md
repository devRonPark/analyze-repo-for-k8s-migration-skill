...
| DET-003 — Detailed golden-set scoring | TODO | Report structure is now close to the contract, so the open question is fact accuracy against the independent golden set. | Not started. |
