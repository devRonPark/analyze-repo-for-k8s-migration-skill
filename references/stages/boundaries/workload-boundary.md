...
this case, and do not cite them if the survey already surfaced them. Leave
`independent_lifecycle_status: "unknown"`; it does not block
`boundary_status: confirmed` or `deployable: true` here.
