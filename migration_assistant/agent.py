        ...
        *,
        ...
        return Agent(
            ...
            instruction=(
                ...
                "주장마다 먼저 search_text hit를 확보하고 그 hit의 repository-relative path와 1-based line을 사용하세요. read_file_lines는 확인된 짧은 범위만 최대 4줄로 요청하고, 응답의 text 또는 excerpt를 Evidence의 excerpt/text에 그대로 복사하세요. path 이름이나 placeholder를 excerpt로 넣지 마세요. "
                ...
                "validation 응답에 evidence_corrections가 있으면 그 안의 path, line, excerpt를 그대로 Evidence에 복사해 재검증하세요. "
