        ...
        *,
        ...
        return Agent(
            ...
            instruction=(
                ...
                "status, summary, evidence, iterations, errors 필드를 가진 전체 AnalysisResult candidate를 validate_analysis Tool에 전달하세요. "
                ...
                "complete는 최소 하나 이상의 line-backed positive Evidence 없이는 금지되며, 모호하면 근거 있는 partial을 제출하세요. "
